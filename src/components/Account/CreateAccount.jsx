...
export const CreateAccount = () => {
	...
	return (
		<section style={{ position: 'relative', height: '96vh' }}>
			<img id="background" className='w-full h-full' src={background} alt='Background Image' style={{ objectFit: 'cover', margin: '20px', filter: `blur(${blurValue}px)` }}
			/>
					...
					<form>
						...
						<div className="mb-6">
							...
							<input
								...
								onChange={handlePasswordChange} // Added onChange event handler
							/>
						</div>
