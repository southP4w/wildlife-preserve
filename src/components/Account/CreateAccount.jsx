				...
				<div className='bg-white bg-opacity-75 shadow-md rounded px-8 pt-6 pb-8 mb-4' style={{maxWidth: '400px'}}>
					<form>
						...
						<div className='mb-6'>
							...
							<input className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline' id='password' type='password' placeholder='Create a password' onChange={handlePasswordChange} // Added onChange event handler
							/>
						</div>
