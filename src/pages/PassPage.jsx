					...
					<div className='grid grid-cols-1 md:grid-cols-70/30 w-full gap-6'>
						...
						<aside>
							...
							<div className='bg-white p-6 rounded-lg shadow-md mt-6'>
								...
								<Link to={`/passes/purchase/${pass.id}`} className='bg-indigo-500 hover:bg-indigo-600 text-white text-center font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block'>Purchase</Link>
							</div>
						</aside>
					</div>
				</div>
